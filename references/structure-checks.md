...
2. **Linter and formatter instructions**: If the file instructs Claude on indentation, naming conventions, import ordering, or similar style rules, flag as MEDIUM. Deterministic tools (eslint, ruff, gofmt, prettier, checkstyle, spotless, google-java-format) enforce these better than prose. Remove and point to the tool config instead.
